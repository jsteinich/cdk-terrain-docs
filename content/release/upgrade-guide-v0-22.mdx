...
<Note>The goal of this first release was to rename the project (old package names are no longer available) and to do this with minimal impact to any existing consumers of the project.</Note>
